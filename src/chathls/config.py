...
HF_DEBUG_ANALYSIS_MODEL = "XXXiong/ChatHLS-HLSFixer"
HF_OPTIMIZE_ANALYSIS_MODEL = "XXXiong/ChatHLS-HLSTuner"
...
class ChatHLSConfig:
    ...
    def from_repo_root(
        ...
        *,
        ...
        debug_analysis_model: str | None = None,
        debug_modify_model: str = DEFAULT_DEBUG_MODIFY_MODEL,
        debug_analysis_model_0: str | None = None,
        debug_analysis_model_1: str | None = None,
        debug_analysis_model_2: str | None = None,
        debug_score_model: str = DEFAULT_DEBUG_SCORE_MODEL,
        optimize_analysis_model: str | None = None,
        optimize_modify_model: str = DEFAULT_OPTIMIZE_MODIFY_MODEL,
    ) -> "ChatHLSConfig":
        runs_dir = repo_root / "runs"
        default_debug_analysis_model = (
            HF_DEBUG_ANALYSIS_MODEL if analysis_backend == "hf" else transform_model
        )
        default_optimize_analysis_model = (
            HF_OPTIMIZE_ANALYSIS_MODEL if analysis_backend == "hf" else transform_model
        )
        resolved_debug_analysis_model = debug_analysis_model or default_debug_analysis_model
        resolved_debug_analysis_model_0 = debug_analysis_model_0 or resolved_debug_analysis_model
        resolved_debug_analysis_model_1 = debug_analysis_model_1 or resolved_debug_analysis_model
        resolved_debug_analysis_model_2 = debug_analysis_model_2 or resolved_debug_analysis_model
        resolved_optimize_analysis_model = optimize_analysis_model or default_optimize_analysis_model
        return cls(
            repo_root=repo_root,
            runs_dir=runs_dir,
            api_key=api_key,
            ...
            debug_analysis_model=resolved_debug_analysis_model,
            debug_modify_model=debug_modify_model,
            debug_analysis_model_0=resolved_debug_analysis_model_0,
            debug_analysis_model_1=resolved_debug_analysis_model_1,
            debug_analysis_model_2=resolved_debug_analysis_model_2,
            debug_score_model=debug_score_model,
            optimize_analysis_model=resolved_optimize_analysis_model,
